...
class CardStack extends Component {
  ...
  getCurrentCardIndex = () => this.state.sindex - 1
  ...
  _nextCard(direction, x, y, duration = 100) {
      ...
      Animated.timing(this.state.drag, {
        ...
        switch (direction) {
          case 'left':
            ...
            this.state.cards[index].props.onRate()
            break
          case 'right':
